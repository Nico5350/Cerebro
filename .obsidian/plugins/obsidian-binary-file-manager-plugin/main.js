...
var Formatter = class {
  ...
  format(input, filepath, createdAt) {
    ...
    const extension = (_a = this.plugin.fileExtensionManager.getExtensionMatchedBest(
      fullname
    )) != null ? _a : "";
...
var BinaryFileManagerSettingTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian5.Setting(containerEl).setName("Enable auto detection").setDesc(
    ...
    new import_obsidian5.Setting(containerEl).setName("Extension to be watched").addText(
    ...
    new import_obsidian5.Setting(containerEl).setName("Forget all binary files").setDesc(
...
var FileListAdapter = class {
  ...
  loadBinaryFiles() {
    return __async(this, null, function* () {
      ...
      const storageFilePath = (0, import_obsidian6.normalizePath)(
...
var MetaDataGenerator = class {
  ...
  uniquefyMetaDataFileName(metaDataFileName) {
    const metaDataFilePath = (0, import_obsidian7.normalizePath)(
      `${this.plugin.settings.folder}/${metaDataFileName}`
    );
    if (this.app.vault.getAbstractFileByPath(metaDataFilePath)) {
      return `CONFLICT-${(0, import_obsidian7.moment)().format(
        "YYYY-MM-DD-hh-mm-ss"
      )}-${metaDataFileName}`;
    } else {
      return metaDataFileName;
  ...
  createMetaDataFile(metaDataFilePath, binaryFile) {
    return __async(this, null, function* () {
      ...
      if (!(this.plugin.settings.useTemplater && templaterPlugin)) {
        ...
        const targetFile = yield this.app.vault.create(
          metaDataFilePath,
          ""
        );
        try {
    ...
    return __async(this, null, function* () {
      ...
      this.registerEvent(
        this.app.vault.on("create", (file) => __async(this, null, function* () {
          ...
          if (!(yield this.metaDataGenerator.shouldCreateMetaDataFile(
            file
          ))) {
            return;
          }
